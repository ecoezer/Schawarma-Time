    ...
    <footer className="bg-[#142328] text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <span className="text-xl font-black">Smash47</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@smash47.de" className="hover:text-white transition-colors">info@smash47.de</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
          <p>© 2026 Smash47. Alle Rechte vorbehalten.</p>
