        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>Sie haben das Recht auf Auskunft, Berichtigung, Löschung und Einschränkung der Verarbeitung Ihrer Daten. Kontaktieren Sie uns unter: datenschutz@smash47.de</p>
            </section>
            <section>
