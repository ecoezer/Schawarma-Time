      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
            ...
            <p><strong>Smash47</strong><br />Bahnhofsallee 14a<br />31134 Hildesheim<br />Deutschland</p>
            <h2 className="text-lg font-bold text-gray-900 mt-6">Kontakt</h2>
            <p>Telefon: 05121 3030551<br />E-Mail: info@smash47.de</p>
            ...
            <p>Smash47<br />Bahnhofsallee 14a<br />31134 Hildesheim</p>
          </div>
        </div>
      </div>
    </div>
